...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Dinesh", "dinesh.dasaratharao.com", "ddineshusa@gmail.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Awesome Api Documentation", "Awesome Api Title", "1.0",
